const CONFIG = {
  ...
  SCHEDULED_URL: 'http://10.59.234.217:8091/api/scheduled-jobs',
  SCHEDULED_FILE_URL: 'scheduled-jobs.json',
...
async function saveScheduleFromModal() {
  ...
  try {
    ...
    closeScheduleModal();
    await openScheduledView(true);
    alert('scheduled-jobs.json updated successfully (' + list.length + ' jobs)');
  } catch (e) {
